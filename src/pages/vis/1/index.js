...
// 텍스트 관련 스타일 컴포넌트는 그대로 유지하지만 실제로 사용하지는 않습니다
  ...
  const initSketch = () => {
    window.emotionalLinesInstance = new window.p5((p) => {
      ...
      p.setup = function() {
        ...
        let redColors = ["#FF0000", "#FF3333", "#FF6666", "#FF9999", "#FFCCCC", "#990000", "#CC0000", "#FF3300", "#CC3333", "#FF0033"];
        color_setup2 = redColors;
        color_bg = "#FFFFFF";
      ...
      p.draw = function() {
        ...
        t += p.random(2, 1) * p.random(0.001, 0.0025) * 2;
      };
